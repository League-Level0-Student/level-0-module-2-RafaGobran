...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		if(heightAsInt > 47) {
			JOptionPane.showMessageDialog(null, "You are tall enough to ride the silver bullet");
		}
		// 5) Else if the heightAsInt is greater than or equal to 42 inches tall print:
		// "You can ride the coaster with someone else!" 
		if(heightAsInt > 41) {
			JOptionPane.showMessageDialog(null, "You are tall enough to ride the silver bullet with a friend");
		}
		// 6) else print: "You must be at least 42 inches tall to ride the roller coaster pal!"
		else {
			JOptionPane.showMessageDialog(null, "Buddy get out of this line!");
} 
}
}